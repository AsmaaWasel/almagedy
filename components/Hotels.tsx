...
export default function HotelsGallery({ hotels }: { hotels: Hotel[] }) {
    ...
    <section className="bg-ivory py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-extrabold text-night">
                  {threeStarHotels[0]?.title || "فنادق 3 نجوم"}
                </h3>
          ...
          {/* ✅ شبكة الصور - 3 نجوم (نفس نظام 5 نجوم) */}
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {threeStarHotels.flatMap((hotel) =>
              hotel.images.map((image, index) => (
                ...
                >
                  ...
                  <div className="absolute left-3 bottom-3 rounded-full bg-black/60 px-3 py-1 text-xs font-bold text-white">
                    ⭐⭐⭐ {hotel.title}
                  </div>
                </motion.div>
              )),
            ...
            {fiveStarHotels.flatMap((hotel) =>
              hotel.images.map((image, index) => (
                ...
                >
                  ...
                  <div className="absolute left-3 bottom-3 rounded-full bg-gold/80 px-3 py-1 text-xs font-bold text-night">
                    👑 {hotel.title}
                  </div>
                </motion.div>
              )),
